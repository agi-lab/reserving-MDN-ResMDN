#ENVIRONMENT 4
#The default environment simulated by the SynthETIC package
...
# for (i in 1:40){
#   oc = occurence[i]
#   y_vec[i] = min(0.85, 0.65 + 0.02 * (oc - 1))
#   y2_vec[i] = max(0.85, 1 - 0.0075 * oc)
# }
# 
# 
# plot(occurence, y_vec, type = "l", col = "red", ylim = c(0,1))
# lines(occurence, y2_vec, col = "blue")
